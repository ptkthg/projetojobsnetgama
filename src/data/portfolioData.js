export const portfolioData = {
  ...
  disclaimer:
    'Todos os projetos apresentados neste portfólio utilizam dados fictícios, simulados ou anonimizados. Nenhuma informação sensível, corporativa ou de terceiros é exposta.',
};
